...
async function getDataFromDB(userId) {
  ...
  queryPosts.forEach((item) => {
    ...
    postsArray.push({
      author: item.data().fullname,
      date: new Date("2025-11-07T17:47:14Z"), // converted from timestamp
      description: "lskdjflk",
      image:
        "https://res.cloudinary.com/deex2hwgz/image/upload/v1762537630/vj81cj1cmq1hzd0fbuqf.png",
      moreDetails: "ksdjflkj",
      title: "Blog 2",
      uid: "xRvisJCgRZfqLhWRodd95jByWbI3",
    });
  });
